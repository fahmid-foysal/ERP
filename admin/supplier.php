...
<head>
    ...
    <title>Mondol Motors - Suppliers</title>
...
<body>
        ...
        <div class="page-wrapper bg-white">
            <div class="container mt-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-primary">supplier</h4>
                    <button class="btn btn-success" onclick="showPopup()">Add supplier</button>
                </div>
    ...
    <script src="assets/api-calls/supplier.js"></script>
</body>
